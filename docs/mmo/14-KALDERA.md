# Brackenwake: the world, the Bond, and Wyrmsoul
...
**Brackenwake.** Three syllables, said the way it looks: kal-DEH-ra. A caldera is
...
Wyrmking's volcano on the eastern rim still burning. The game is *Brackenwake*. The
big ability is *Wyrmsoul*. The player is *Dragonsworn*.

If Brackenwake does not land: *Ashfall* (soft, mournful, easy) or *Skarrow* (hard,
...
Ten thousand years ago dragons ruled Brackenwake and the first riders made a pact
...
name is the player's. Nobody in Brackenwake calls you "Dragonsworn" to your face
...
Brackenwake is a ring of realms around a central sea, the Caldera Sea, with the
...
**The story here.** The Isles are the pirate republic of Brackenwake and the only
...
**The endings.**
- **The hearts freed.** Nine hearts released; they fly, and Brackenwake has dragons
