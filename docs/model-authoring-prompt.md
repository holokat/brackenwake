...
> | name | hex | use |
> | --- | --- | --- |
> | `farm-wood` | `#A8783F` | planks, posts, beams |
...
> | `farm-grass` | `#7C9440` | grass and turf — mid olive-green, NOT lime |
> | `farm-leaf` | `#4E8A32` | foliage |
> | `farm-leaf-dark` | `#33632A` | foliage in shadow, mossy earth banks |
