...
import {canonicalSlots,outfitComponentById} from '../../vendor/living-studio/models/class-profiles.js';
...
export function studioEquipment(equipment={},opts={}){
 ...
 return{armor,explicitArmor:!!outfitArmor,weapon,off,main,offItem:off==='none'?null:equipment.offHand};
}
