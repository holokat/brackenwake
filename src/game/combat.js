...
export function createCombat({ floaters, hud, audio, progression, recompute, rng = Math.random } = {}) {
  ...
  function teach(lessons, attacker, defender) {
    // Combat no longer changes numeric skills or stats. Defeats award level
    // experience through character_levels; professions retain their own
    // practice paths outside the combat resolver.
    return 0;
  }
