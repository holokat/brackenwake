...
export const ABILITY_VISUALS = {
  ...
  'dual-strike': v('slash', '#d8dbe2', 0.9, 2, 'arc', 'thrust'),
  'deep-cut': v('slash', '#b94a58', 0.9, 3, 'arc'),
  'throwing-knife': v('projectile', '#d6d0c4', 0.55, 1, 'shards', 'thrust'),
  'kidney-shot': v('impact', '#b0a2c4', 0.65, 2, 'shards', 'thrust'),
  'finishing-strike': v('slash', '#f0d0a0', 1.05, 2, 'arc', 'thrust'),
