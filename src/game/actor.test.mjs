...
// ---- monster resists, weaknesses, ai, faction -------------------------------
{
  ...
  check('and every row that carries the tag really has it, including Abbot Cinder',
    carriers.length === 6 && carriers.some(m => m.id === 'abbotCinder') && carriers.every((m) => spawnMonster(m.id, { x: 0, y: 0, z: 0 }, () => 0.5).resists.fire === 70),
