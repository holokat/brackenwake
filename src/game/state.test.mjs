...
// ---- v2 save and load ------------------------------------------------------
{
  ...
  check('the save shape is the 07 document', JSON.stringify(Object.keys(raw).sort()) === '["appearance","bar","bosses","deadUntil","discovered","dragon","equipment","gold","health","heldTool","mana","name","needsCreation","opened","opening","pack","pos","settings","skillLocks","skills","stamina","statLocks","stats","story","uniques","v","waypoint","waystones","zones"]', Object.keys(raw).join(','));
