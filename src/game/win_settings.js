...
export const SETTINGS = [
  ...
  { key: 'pixelRatio', label: 'Maximum pixel ratio', kind: 'choice', options: [1, 1.5, 'device'], def: 1.5,
    apply: 'renderer.setPixelRatio(v === "device" ? devicePixelRatio : 1)',
    help: 'The 3D view adjusts below this limit during sustained slowdowns, then recovers gradually. Text and controls stay sharp. Device is capped at double density.' },
