...
export const SETTINGS = [
  ...
  { key: 'pixelRatio', label: 'Pixel ratio', kind: 'choice', options: [1, 1.5, 'device'], def: 1.5,
    apply: 'renderer.setPixelRatio(v === "device" ? devicePixelRatio : 1)',
    help: 'One and a half balances clarity and speed. One is faster. Device uses your screen resolution, capped at double density.' },
