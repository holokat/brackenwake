...
// ===========================================================================
{
  ...
  check('and the frame order is the sixteen live systems including the shared cellar raid',
    FRAME_ORDER.join(',') === 'world,player,emotes,combat,abilities,inventory,world_life,events,story,ui,sound,net,cellar_raid,context_menu,dev,input', FRAME_ORDER.join(','));
  ...
  check('the build order is the one R1.md documents',
    sys.built.join(',') === 'world,player,combat,inventory,abilities,ui,emotes,world_life,events,story,sound,net,cellar_raid,context_menu,dev,input', sys.built.join(','));
