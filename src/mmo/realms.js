...
export const REALMS = [
  {
    ...
    places: [
      ...
      p('oldcellars', 'The Old Cellars', 'dungeon', 'Brick cellars under the mill, older than the mill, running under the river.', 'The Legion\'s advance party: bandits and goblins; Sergeant Oram Blackhand with the stolen sack, in a room too low to swing cleanly', { boss: 'Sergeant Oram Blackhand', levels: 1 }),
