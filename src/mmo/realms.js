...
export const REALMS = [
  {
    ...
    places: [
      p('hearthhome', 'Hearthhome', 'hub', 'A village on a green with a stone bridge, a church, an inn and a smith, all inside the ring of stones.', 'Bram Haywood, Old Wynn Ashby, Pip, the Bracken Arms, the smith, the healer, the market; the egg hatches here'),
      ...
      p('oldcellars', 'The Old Cellars', 'dungeon', 'Brick cellars under the mill, older than the mill, running under the river.', 'The Legion\'s advance party: bandits and goblins; Sergeant Oram Blackhand with the egg\'s shell; the first Wyrmsoul call, in a room too low to fly', { boss: 'Sergeant Oram Blackhand', levels: 1 }),
      ...
      p('waystones', 'The Waystones', 'landmark', 'Nine of the Standing Hedge\'s stones hum at dusk; each is twinned with a stone in another realm.', 'Fast travel between stones you have touched with the dragon on your shoulder; the Legion cannot use them', { mechanic: 'Touch a stone with the dragon awake and it is yours; from then on any waystone carries you to any other you own, once a day per stone. The Legion has tried for a century and been refused.' }),
  ...
  },
  {
    ...
    places: [
      ...
      p('templeoffaces_deep', 'The Deep of Faces', 'dungeon', 'Galleries behind the cliff where the first riders learned the sight, walls of eyes.', 'Spiders, Legion cultists, the Keeper of Faces; the gift of the senses; your face added to the cliff', { boss: 'The Keeper of Faces', levels: 2 }),
      ...
      p('sunkenshrine', 'The Sunken Shrine', 'shrine', 'A dragon shrine half under the river where the roots have lifted the stones.', 'A gift for the hatchling, the first true-name rumour'),
      ...
      p('hanginggardens', 'The Hanging Gardens', 'landmark', 'Terraces of the old temple grown into the cliff face, reached by climbing roots and rope, a hundred feet of vertical garden.', 'Rare forage on every terrace, a harpy roost at the top, a view of the whole Deep', { mechanic: 'Climbing: roots are handholds, and a wet root after rain gives way. Fall damage applies. The dragon, once a drake, catches you once per climb.' }),
      ...
      p('spiderwells', 'The Spider Wells', 'cave', 'Sinkholes in the jungle floor webbed over, a cave maze beneath joined by silk bridges.', 'Giant spiders, silk to harvest for the tailor, Mother Web\'s brood', { mechanic: 'Silk bridges bear your weight and not the dragon\'s once it is a drake; cut a bridge behind you and what is chasing falls.' }),
    ],
  ...
  },
  {
    ...
    places: [
      p('redqueensharbour', 'The Red Queen\'s Harbour', 'hub', 'The pirate republic\'s capital across a dozen islets, chain bridges, a mast lighthouse.', 'Queen Maravel, Grey Tancred\'s barge fleet at anchor, the boat you are given, sailing and fishing training, salvage market'),
      p('drownedmill', 'The Drowned Mill', 'hamlet', 'A stilt-house on an old mill in the fen, the wheel standing in dry sedge.', 'Aldo Reeve and the eel family, the safe paths through the sedge, Long Sarah fed monthly'),
      ...
      p('leviathansrest', 'The Leviathan\'s Rest', 'dungeon', 'A sea cave under the largest isle where the last sea-wyrm lies, tide-filled.', 'Crabs, drowned, a mire troll, Thalassa the Sea-Wyrm; the gift of the tail', { boss: 'Thalassa the Sea-Wyrm', levels: 2 }),
  ...
  },
  {
    ...
    places: [
      ...
      p('firstfire', 'The Firstfire Crater', 'dungeon', 'The crater where the pact was made, a Legion foundry cut into its wall and the throat beneath.', 'Cyclops, cultists, iron golems; the gift of true fire; the walls light for the first time in a thousand years', { boss: 'The Brass Heart (if not turned)', levels: 2 }),
  ...
  },
  {
    ...
    places: [
      ...
      p('cairnroad', 'The Cairn Road', 'road', 'The path to the Eyrie, a cairn for every fallen rider, speaking when the dragon is near.', 'Rider cairns, the Wall of Weather event, ogres of the Legion\'s mountain corps'),
      ...
      p('eyrie', 'The Eyrie', 'megastructure', 'The riders\' hall on the peak, the landing steps, nine stone perches, ghosts keeping watch.', 'Marshal Eowen Skyward\'s ghost, the last Dragonsworn, the Bond\'s true use, the wings; the Roost beneath', { dungeon: 'eyrieroost' }),
  ...
  },
  {
    ...
    places: [
      ...
      p('skulllodge_throat', 'The Trophy Throat', 'dungeon', 'Down the skull\'s throat into the neck bones, trophies on every vertebra.', 'Bone knights, wraiths, vampire knights, Gallow\'s hounds; Huntmaster Gallow; the gift of the roar', { boss: 'Huntmaster Gallow', levels: 2 }),
  ...
  },
  {
    ...
    places: [
      ...
      p('icevault', 'The Ice Vault', 'megastructure', 'The glacier with the fortress and the tenth dragon inside it, the Legion cutting toward her.', 'Vaelith the Frost, the gift of frost and the ten seconds; the Vault beneath', { dungeon: 'icevault_deep' }),
      ...
      p('icefall', 'Icefall', 'cave', 'A cave behind a frozen waterfall, blue light, the water still moving under the ice.', 'Rimesteel in the walls, an ice troll, a frozen Legion sapper crew', { mechanic: 'Fire melts the way in and the way out both; without a torch or the dragon the entrance refreezes behind you in ten minutes.' }),
      p('hotsprings', 'The Hot Springs', 'landmark', 'Steaming pools in the pine under the glacier, the only warm ground in the realm.', 'Rest, the cold bar reset, giants bathing who will talk, a hidden way to the Vault', { mechanic: 'Warmth is a resource in Frostreach; the springs and the dragon are the two ways to refill it in the open.' }),
  ...
  },
  {
    ...
    places: [
      ...
      p('drownedpalace', 'The Drowned Palace', 'dungeon', 'The king\'s own, entirely under water, air pockets as rooms.', 'Drowned, vampire knights of the old court, the guardian Bone Dragon; King Caradoc if lied to; the gift of the deep', { boss: 'King Caradoc the Drowned', levels: 3 }),
  ...
  },
  {
    ...
    places: [
      ...
      p('throneofash', 'The Throne of Ash', 'dungeon', 'The fortress, the crater, the heart-hall.', 'The Legion\'s best, bone knights, the Brass Heart if not turned, Malachar in three phases; the last gift; the three endings', { boss: 'Malachar, the Wyrmking', levels: 3 }),
      ...
      p('heartcages', 'The Heart Cages', 'landmark', 'The wall behind the throne, nine iron cages, nine hearts beating.', 'The ending: free them, eat them, or give your dragon\'s', { mechanic: 'Each cage opens to a roar from a dragon that holds that realm\'s gift; nine gifts, nine cages, or fewer if you came with less.' }),
    ],
