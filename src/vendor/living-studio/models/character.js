...
import {createLegacyCharacter} from './armor/legacy-character.js';
...
export async function createCharacter(kind,{rigged=true,bodyType='male',equipment={},equipmentMaterials={},customization={}}={}){
