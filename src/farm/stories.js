...
export const STORIES = [
  ...
  S({
    ...
    choices: [
      ...
      { label: 'Leave it standing', hint: 'full yield if the frost misses — nothing if it does not',
        modifier: { key: 'frostRisk', value: 0.5, days: 1 } },
    ],
  ...
  S({
    ...
    choices: [
      ...
      { label: 'Let it rest', hint: 'the fish come back stronger in spring',
        modifier: { key: 'fishStock', value: 1.4, days: 30 } },
    ],
  ...
  S({
    ...
    choices: [
      { label: 'Take it', hint: 'swings come round quicker',
        unlock: 'brams_axe', rep: { bram: 1 }, modifier: { key: 'chopSpeed', value: 0.85, days: 9999 } },
    ],
  ...
  S({
    ...
    choices: [
      { label: 'Ask him to stay on', hint: 'Bram works the farm with you',
        unlock: 'bram_hand', modifier: { key: 'productionMult', value: 1.15, days: 9999 } },
  ...
  S({
    ...
    choices: [
      { label: 'Fell it', hint: 'triple timber — and the birds leave this zone',
        goods: { wood: 45 }, flag: 'old_tree_felled', modifier: { key: 'birdsong', value: 0, days: 9999 } },
  ...
  S({
    ...
    choices: [
      ...
      { label: 'Buy a new colony', hint: 'fixes the symptom. It will happen again.',
        coins: -120, flag: 'bees_rebought' },
    ],
  ...
  S({
    ...
    choices: [
      { label: 'Hunt', hint: 'meat now — and they avoid your land for a while',
        act: { huntDeer: true }, modifier: { key: 'deerAvoid', value: 1, days: 12 } },
      { label: 'Fence the field', hint: '20 wood, and it is permanent',
        needs: { wood: 20 }, goods: { wood: -20 }, flag: 'deer_fenced' },
      { label: 'Plant them a strip', hint: 'give up a plot. They stay, and they are easy to find.',
  ...
  S({
    ...
    choices: [
      { label: 'The cheap fix', hint: 'a generator, financed — you pay double over the season',
        unlock: 'enr_generator', coins: -80, modifier: { key: 'debt', value: 240, days: 20 } },
  ...
  S({
    ...
    choices: [
      ...
      { label: 'Risk it', hint: 'or do not',
        modifier: { key: 'counterfeitRisk', value: 1, days: 7 } },
    ],
  }),
